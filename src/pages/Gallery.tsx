...
export default function Gallery() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-accent-yellow selection:text-deep-purple">
      <SEO
        title="Gallery — Archives of the Kingdom"
        description="Jelajahi koleksi fanart dan visual legacy dari Arcsla Kingdom. Karya seni buatan komunitas kreator digital Indonesia."
        url="https://arcsla.net/gallery"
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "CollectionPage",
          name: "Arcsla Kingdom Gallery",
          description: "Koleksi fanart dan visual legacy dari komunitas kreator Arcsla Kingdom.",
          url: "https://arcsla.net/gallery",
          isPartOf: {
            "@type": "WebSite",
            name: "ARCSLA Kingdom",
      ...
      <main className="pt-32 pb-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl md:text-6xl font-sans font-black text-deep-purple uppercase tracking-tighter mb-4">
              Archives of <br />
              the Kingdom
            </h1>
            <p className="text-xl text-muted-foreground italic max-w-2xl mx-auto leading-relaxed">
              Every stroke of the brush and every frame captured is a tribute to our sovereign
              creativity. Explore the full collection of legendary fanart.
            </p>
          </div>
              ...
              <div className="mt-12 text-center h-20 flex items-center justify-center">
                {galleryLoading && (
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <p className="text-xs font-black uppercase tracking-widest text-accent-purple/60">
                      Summoning more treasures...
                    </p>
                  </div>
                )}
                {!hasMoreGallery && items.length > 0 && (
                  <p className="text-xs font-black uppercase tracking-widest text-muted-foreground italic">
                    You have beholden all our royal archives.
                  </p>
                )}
              </div>
            </>
