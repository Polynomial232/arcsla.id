...
const MediaItem = ({
  ...
  return (
    <img
      ...
      className={cn(
        className,
        "object-contain cursor-pointer bg-black/5 transition-opacity duration-500",
        isLoaded ? "opacity-100" : "opacity-10",
      )}
      onClick={onClick}
            ...
            <motion.div
              ...
              className={cn(
                ...
                selectedItem.id === item.id
                  ? "border-accent-yellow scale-110 shadow-lg"
        ...
        {mediaItems.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <motion.div className="absolute inset-x-0 bottom-0 p-4 translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
